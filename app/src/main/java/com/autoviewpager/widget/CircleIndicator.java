...
public class CircleIndicator implements ViewPager.OnPageChangeListener {

    private Context context;
    private ViewPager viewPager;
    private LinearLayout dotLayout;
    private int size;
    private int img1 = R.drawable.dot_focused_white, img2 = R.drawable.dot_normal;
    private int imgSize = 15;
    private List<ImageView> dotViewLists = new ArrayList<>();

    public CircleIndicator(Context context , ViewPager viewPager , LinearLayout linearLayout , int size) {
